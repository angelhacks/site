...
- **Construct 3 Games**
Construct 3 is a HTML-based game editor that allows you to make super awesome games. 
...
- **Top Prize**
Guided SpaceX Tour for top teams and individuals.
Headphones, speakers, and other tech prizes.
- **Category: EDUCATION Winner(s)**
Sketch licenses (a vector graphics editor that won the Apple Design Award in 2012)
Retro-Bit Gaming system
- **Category: ENVIRONMENT Winner(s)**
Amazon Echo Dot 
Cloudsploit PRO and PREMIUM memberships
- **Best Web Hack**
Zeit.co mentorship and support on your projects.
- **Best Hardware Hack**
Arduino's, Raspberry Pi's, and more, to your heart's content!
- **Your prize, for attending!**
Balsamiq 90-day membership (a mockup website great for UX design)
SashiDo credits worth 30 days
Wolfram 30-day membership (access to their Wolfram development platform and API)

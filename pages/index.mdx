...
Zeit.co will teach a workshop on making a website with Next.js, which is what this website is built with!
- **GitKraken**
GitKraken is a very useful tool in project development!
- **Game Dev**
Want to learn how to make a game? We'll be using Unity to make a simple game.
- **Artificial Intelligence**
A DeepAI data scientist will teach how to make a basic neural network! 
- **UX Design**
A workshop that teaches you how to design using Sketch and Balsamiq.
